...
class KeywordFile:
    ...
    def get_nodes(self):
        ...
        for idx, loc in enumerate(self.keywordlocations):
            ...
            if self.string[loc + 1 : loc + 1 + title_length] == "NODE":
                ...
                # create keyword object
                new_keyword = Nodes(new_keyword_string, new_keyword_range, self.format)
    ...
    def get_set(self, settype: str):
        ...
        for idx, loc in enumerate(self.keywordlocations):
            ...
            if self.string[loc + 1 : loc + 1 + title_length] == "SET_" + settype:
                ...
                # create keyword object
                new_keyword = Set(new_keyword_string, new_keyword_range, self.format)
                keyword_list.append(new_keyword)
    ...
    def replace_keyword(self, keyword_to_replace):
        ...
        self.string = (
            old_keyfile_string[0 : insert_range[0]]
            + insert_string
            + "\n"
